...
Model.prototype.start = function() {
  ...
  */
    ...
    client.on('connect', () => {
      ...
      clientSub.on('connect', async function () {
      ...
      clientSub.on('pmessage', async function (_, topic, payload) {
...
Model.prototype.add = async function (name, service_name) {
  ...
  return await client.hset(`device/${id}`, "id", id)
}
...
Model.prototype.remove = async function (name, service_name) {
  ...
  await client.del(`device/${name}.${service_name || name}`)
}
